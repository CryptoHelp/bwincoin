...
int64 nChainStartTime = 1400850428;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 1000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "May 23, 2014, the bwincoins coming from USA.";
        CTransaction txNew;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0x82368559e85e978a15276b82bf2c2b1ad7d52e6dd1655e382b44e27915445a18"));
